...
If you need to install WP-CLI manually for a simple action you can download the `wp-cli.phar` file from the WP-CLI GitHub repository and run on the server. You can find more information about the manual installation in the [WP-CLI documentation](https://developer.wordpress.org/cli/commands/).
