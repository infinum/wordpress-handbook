When you want to develop a WordPress app, or you are joining an existing project, it is important to have a local development ready. There are a number of solutions that can be used.
